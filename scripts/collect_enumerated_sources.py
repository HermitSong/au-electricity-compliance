...
def main():
    ...
    root, archive, output = args.root.resolve(), args.archive_root.resolve(), args.output_root.resolve()
    ...
    log = output / 'source-originals/manifest.jsonl'
    ...
    fetcher = Fetcher({'aemo.com.au'}, 20, 40 * 1024 * 1024, 1.0)
    ...
    (output / 'batch-summary.json').write_text(json.dumps(report, indent=2) + '\n', encoding='utf-8')
